  ...
  theme: {
    ...
    extend: {
      ...
      keyframes: {
        ...
        'neon-breathe': {
          '0%, 100%': { borderColor: 'rgba(176, 38, 255, 0.4)', boxShadow: '0 0 12px rgba(176, 38, 255, 0.2)' },
          '50%': { borderColor: 'rgba(176, 38, 255, 0.8)', boxShadow: '0 0 28px rgba(176, 38, 255, 0.45)' },
        },
      },
      animation: {
